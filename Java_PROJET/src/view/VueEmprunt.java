...
public class VueEmprunt extends JPanel {
    ...
    private void styleTable() {
        ...
        tableEmprunts.setShowVerticalLines(false);
    ...
    public void refreshTable(Object[][] data) {
        modelEmprunts.setRowCount(0);
        for (Object[] row : data) {
            modelEmprunts.addRow(row);
        }
    }
    ...
    public int getSelectedEmpruntId() {
        ...
        if (selectedRow != -1) {
            return (int) tableEmprunts.getValueAt(selectedRow, 0);
        }
        return -1;
    }
    ...
    public int showConfirmDialog(String message, String title) {
        return JOptionPane.showConfirmDialog(parentFrame, message, title, JOptionPane.YES_NO_OPTION);
    }
